        ...
        if file:
            ...
            if image is not None:
                ...
                if roi.size == 0:
                    ...
                    if blue_intensity <= 166.91:
                        intensity_info = "น้อยมาก (0 - 0.039)"
                    elif 166.92 <= blue_intensity <= 183.25:
                        intensity_info = "น้อย (0.78 - 1.56)"
                    elif 183.26 <= blue_intensity <= 187.58:
                        intensity_info = "ปานกลาง (1.57 - 3.125)"
                    elif 187.59 <= blue_intensity <= 194.08:
                        intensity_info = "สูง (3.126 - 6.25)"
                    else:
                        intensity_info = "สูงมาก (6.26 - 50)"
